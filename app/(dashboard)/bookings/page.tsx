          ...
          <form onSubmit={handleSave} className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="space-y-1.5">
                ...
                <datalist id="booking-vehicles-list">
                  <option value="WAGNOR" />
                ...
                <Input required list="booking-vehicles-list" className="h-10 rounded-[12px] text-[14px]" value={vehicle} onChange={(e) => setVehicle(e.target.value as VehicleType)} placeholder="Select or type vehicle" />
              </div>
